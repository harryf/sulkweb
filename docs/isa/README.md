...
| [realtime-2x.md](realtime-2x.md) | The 2.x real-time line: the three planning runs, stage 1 (the clock), stage 2 (individual orders), the alpha.2 facing fix and its write-up |
