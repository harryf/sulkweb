...
**Command pause (unmetered, stage 3):** Space stops the clock with the board readable. Right-click orders, squad orders, Tab and Esc still go; the direct-control keys wait; Space resumes. The metered pool is stage 4.
